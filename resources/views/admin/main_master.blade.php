...
<head>
    ...
    <meta charset="utf-8" />
    <title>Dashboard | Neguinho Motors - Administration & Dashboard</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Neguinho Motors Administration & Dashboard Template" name="description" />
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="/admin" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="{{ asset('assets-admin/images/neguinho-logo.png') }}" alt="logo-sm" height="22">
                            </span>
                            <span class="logo-lg">
                                <img src="{{ asset('assets-admin/images/neguinho-logo.png') }}" alt="logo-dark" height="20">
                            </span>
                        </a>

                        <a href="/admin" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="{{ asset('assets-admin/images/neguinho-logo.png') }}" alt="logo-sm-light" height="22">
                            </span>
                            <span class="logo-lg">
                                <img src="{{ asset('assets-admin/images/neguinho-logo.png') }}" alt="logo-light" height="20">
                            </span>
                        </a>
                    </div>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-none d-sm-inline-block">
                        <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="" src="{{ asset('assets-admin/images/flags/gbp.png') }}" alt="Header Language" height="16">
                        </button>
                        <div class="dropdown-menu dropdown-menu-end">

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('assets-admin/images/flags/br.png') }}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Portuguese</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('assets-admin/images/flags/us.jpg') }}" alt="user-image" class="me-1" height="12"> <span class="align-middle">American</span>
                            </a>
                    ...
                    <div class="dropdown d-inline-block user-dropdown">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="rounded-circle header-profile-user" src="{{ asset('assets-admin/images/users/emm-avatar.png') }}" alt="Header Avatar">
                            <span class="d-none d-xl-inline-block ms-1">Emmanuel</span>
        ...
        <div class="vertical-menu">
            ...
            <div data-simplebar class="h-100">
                ...
                <div class="user-profile text-center mt-3">
                    <div class="">
                        <img src="{{ asset('assets-admin/images/users/emm-avatar.png') }}" alt="" class="avatar-md rounded-circle">
                    </div>
                    <div class="mt-3">
                        <h4 class="font-size-16 mb-1">Emmanuel Nwokedi</h4>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            </script> © 2023 Neguinho Motors Limited.
                        </div>
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Designed & Developed by <em>"M"</em>
                            </div>
                        </div>
                    </div>
                </div>
