...
<!-- Accordion Menu -->
<!-- <script type="text/javascript" src="{{asset('accordion-menu/js/jquery-1.11.1.min.js')}}"></script> -->
<!-- <script type="text/javascript" src="{{asset('accordion-menu/js/jquery-accordion-menu.js')}}"></script> -->
