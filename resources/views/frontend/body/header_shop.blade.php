    ...
    <header id="header" class="header clearfix">
        ...
        <div class="container-fluid container-width-93 clearfix" id="site-header-inner">
            <div id="logo" class="logo float-left">
                <a href="/" title="logo">
                    <img src="{{ asset('storage/img/icon.png') }}" alt="image" width="54" height="12" data-retina="{{ asset('storage/assets-frontend/img/logo-2.png') }}" data-width="54" data-height="12">
                </a>
            </div><!-- /.logo -->
