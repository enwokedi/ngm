                ...
                <div class="flat-image-box style-2 absolute-right flat-carousel-box" data-gap="0" data-auto="false" data-column="1" data-column2="1" data-column3="1">
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="inner">
                                <div class="thumb">
                                    <img src="{{ Vite::asset('resources/images/home/for-sale.jpg') }}" alt="Image">
            ...
            <div class="col-md-3">
                ...
                <div class="flat-image-box style-1 absolute-center row2 data-effect clearfix">
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img src="{{ Vite::asset('resources/images/home/tyres.jpg') }}" alt="Image">
                                <div class="text-wrap text-center">
                    ...
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img src="{{ Vite::asset('resources/images/home/rentals.jpg') }}" alt="Image">
                                <div class="text-wrap text-center">
            ...
            <div class="col-md-3">
                ...
                <div class="flat-image-box style-1 absolute-center row2 data-effect clearfix">
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img src="{{ Vite::asset('resources/images/home/accidents.jpg') }}" alt="Image">
                                <div class="text-wrap text-center">
                    ...
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img src="{{ Vite::asset('resources/images/home/spare-parts.jpg') }}" alt="Image">
                                <div class="text-wrap text-center">
            ...
            <div class="col-md-4">
                <div class="flat-image-box style-1 absolute-center data-effect clearfix">
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img src="{{ Vite::asset('resources/images/home/products610x377.jpg') }}" alt="Image">
                                <div class="text-wrap text-center">
                                    <h2 class="font-size-30 line-height-36 font-weight-600"><a class="text-white" href="/product-types">PRODUCTS</a></h2>
                                </div>
                                <div class="overlay-effect bg-color-2"></div>
                            </div>
                        </div>
            ...
            <div class="col-md-4">
                ...
                <div class="flat-image-box style-1 absolute-center data-effect clearfix">
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img src="{{ Vite::asset('resources/images/home/gps-tracker.jpg') }}" alt="Image">
                                <div class="text-wrap text-center">
            ...
            <div class="col-md-4">
                ...
                <div class="flat-image-box style-1 absolute-center data-effect clearfix">
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img src="{{ Vite::asset('resources/images/home/services.jpg') }}" alt="Image">
                                <div class="text-wrap text-center">
